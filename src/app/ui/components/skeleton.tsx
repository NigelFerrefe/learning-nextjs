...
/**
 * Renders a skeleton placeholder for a list of posts.
 * This is typically used to indicate loading state before actual post data is available.
 * 
 * @returns A fragment containing four `PostSkeleton` components.
 */
